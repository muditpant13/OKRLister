/**
 * All user facing strings, including display strings and error messages
 */
export const SEE_MORE = 'See more',
  ...
  SELECT_TEST_HEADER_TEXT =
    'Select any test from below mentioned list to assess whether you may be sufferring from any specific mental health issue',
